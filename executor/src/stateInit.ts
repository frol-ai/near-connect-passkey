...
import { DEFAULT_TIMEOUT_SECS, WALLET_CODE_IDS } from "./constants";
...
export function serializeDefaultStateInit(publicKey: PasskeyPublicKey): Uint8Array {
  ...
  return serializeStateInit({ account_id: WALLET_CODE_IDS[publicKey.curve] }, [
...
export function defaultStateInitJson(publicKey: PasskeyPublicKey): StateInitJson {
  return {
    V1: {
      code: { account_id: WALLET_CODE_IDS[publicKey.curve] },
